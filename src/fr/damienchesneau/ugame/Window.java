...
public class Window extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBackground(new java.awt.Color(143, 122, 102));
        jButton1.setForeground(new java.awt.Color(249, 246, 242));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jPanelPlateau, javax.swing.GroupLayout.DEFAULT_SIZE, 484, Short.MAX_VALUE)
...
/*
    ...
    private void initPlat() {
        ...
        setColumn1Cell3Value(Levels.NONE);
        setColumn1Cell4Value(Levels.NONE);
        setColumn2Cell1Value(Levels.NONE);
        setColumn2Cell2Value(Levels.NONE);
        setColumn2Cell3Value(Levels.NONE);
        setColumn2Cell4Value(Levels.NONE);
        setColumn3Cell1Value(Levels.NONE);
        setColumn3Cell2Value(Levels.NONE);
        setColumn3Cell3Value(Levels.NONE);
        setColumn3Cell4Value(Levels.NONE);
        setColumn4Cell1Value(Levels.NONE);
        setColumn4Cell2Value(Levels.NONE);
        setColumn4Cell3Value(Levels.NONE);
        setColumn4Cell4Value(Levels.NONE);
    }

    public void setColumn1Cell1Value(Levels level) {
        updateLevel(level, 1, 1);
    }

    public void setColumn1Cell2Value(Levels level) {
        updateLevel(level, 1, 2);
    }

    public void setColumn1Cell3Value(Levels level) {
        updateLevel(level, 1, 3);
    }

    public void setColumn1Cell4Value(Levels level) {
        updateLevel(level, 1, 4);
    }

    public void setColumn2Cell1Value(Levels level) {
        updateLevel(level, 2, 1);
    }

    public void setColumn2Cell2Value(Levels level) {
        updateLevel(level, 2, 2);
    }

    public void setColumn2Cell3Value(Levels level) {
        updateLevel(level, 2, 3);
    }

    public void setColumn2Cell4Value(Levels level) {
        updateLevel(level, 2, 4);
    }

    public void setColumn3Cell1Value(Levels level) {
        updateLevel(level, 3, 1);
    }

    public void setColumn3Cell2Value(Levels level) {
        updateLevel(level, 3, 2);
    }

    public void setColumn3Cell3Value(Levels level) {
        updateLevel(level, 3, 3);
    }

    public void setColumn3Cell4Value(Levels level) {
        updateLevel(level, 3, 4);
    }

    public void setColumn4Cell1Value(Levels level) {
        updateLevel(level, 4, 1);
    }

    public void setColumn4Cell2Value(Levels level) {
        updateLevel(level, 4, 2);
    }

    public void setColumn4Cell3Value(Levels level) {
        updateLevel(level, 4, 3);
    }

    public void setColumn4Cell4Value(Levels level) {
        updateLevel(level, 4, 4);
    }

    private void updateLevel(Levels level, int column, int cell) {
        JPanel jpanel = null;
        JLabel jlabel = null;
        try {
