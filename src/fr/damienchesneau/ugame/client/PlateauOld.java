 ...
 */
public class PlateauOld implements Cloneable {
    ...
    public PlateauOld() {
        ...
        ihm = new Window(new Commands(null));
    }
...
//        System.out.println("Votre score="+score);
    ...
    public Object clone() throws CloneNotSupportedException {
        PlateauOld copy = (PlateauOld) super.clone();
    ...
    public boolean equals(Object obj) {
        boolean ret = false;
        if (obj instanceof PlateauOld) {
            PlateauOld p2 = (PlateauOld) obj;
            ret = true;
            for (int i = 0; i < PLATEAU_HEIGHT; i++) {
                for (int j = 0; j < PLATEAU_WIDTH; j++) {
